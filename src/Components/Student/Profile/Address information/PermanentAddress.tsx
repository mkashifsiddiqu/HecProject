  ...
  return (
    <div>
        ...
        <Paper>
          ...
          <Box paddingBottom={"10px"} display={"flex"} justifyContent={"space-between"}><Typography color="#48465b" fontSize={15.6} fontWeight={700}>Permanent Address</Typography><Tooltip title={'Edit Details'}><motion.div whileHover={{scale:1.1, color:"green"}}><EditIcon sx={{width:"18px", height:"18px"}} /></motion.div></Tooltip></Box>
          <Divider></Divider>
        </Box>
        <Grid container>
          <Grid item xs={12}>
